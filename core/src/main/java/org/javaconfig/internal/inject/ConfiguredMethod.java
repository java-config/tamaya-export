...
public class ConfiguredMethod {
    ...
    /**
     * This method evaluates the {@link org.javaconfig.Configuration} that currently is valid for the given target field/method.
     *
     * @return the {@link org.javaconfig.Configuration} instance to be used, never null.
     */
    ...
    public Object getValue(Object[] args) throws ConfigException {
        ...
        try {
            ...
            if (configValue == null) {
                ...
                LoggerFactory.getLogger(getClass()).info("No config value found for " +
