 ...
 * {@link org.javaconfig.spi.EnvironmentManagerSingletonSpi}. It is possible to define multiple
 * {@link PropertyProviderManager} instances, if required. <h3>Implementation
...
public interface PropertyProviderManager{
	...
	/**
	 * Access all defined {@link org.javaconfig.PropertyProvider} keys.
	 *
	...
	/**
	 * Access a {@link org.javaconfig.PropertyProvider} by key.
	 *
	 * @param key
	 *            The key of the required {@link org.javaconfig.PropertyProvider}, not
	 *            {@code null}.
	 * @return the corresponding {@link org.javaconfig.PropertyProvider} corresponding to the
	 *         {@code key}.
	 * @throws org.javaconfig.ConfigException
	...
	/**
	 * Allows to check if a {@link org.javaconfig.PropertyProvider} with the given key is
	 * defined.
	 *
	 * @param key
     *            The key of the required {@link org.javaconfig.PropertyProvider}, not
     *            {@code null}.
	 * @return true, if the given {@link org.javaconfig.PropertyProvider} is defined.
	 */
