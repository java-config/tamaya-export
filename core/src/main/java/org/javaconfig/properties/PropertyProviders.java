...
public final class PropertyProviders {
    ...
    private static final Logger LOG = LoggerFactory.getLogger(PropertyProviders.class);
    ...
    /**
     * Creates a new read-only {@link org.javaconfig.PropertyProvider} by reading the according path resources. The effective resources read
    ...
    /**
     * Creates a new read-only {@link org.javaconfig.PropertyProvider} based on the resources defined by the given paths. The effective resources
    ...
    /**
     * Converts a given {@link org.javaconfig.PropertyProvider} instance into a serializable and immutable form,
    ...
    /**
     * Creates a {@link org.javaconfig.PropertyProvider} where all keys of a current map,
     * existing in another map are replaced
     * with the ones from the other {@link org.javaconfig.PropertyProvider}. The filter hereby is
     * applied dynamically on access, so also runtime changes of the base map are reflected appropriately.
