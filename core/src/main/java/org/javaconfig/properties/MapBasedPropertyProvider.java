...
/**
 * Models a {@link org.javaconfig.PropertyProvider} that can be build using a builder pattern.
 *
...
class MapBasedPropertyProvider extends AbstractPropertyProvider{
    ...
    private static final Logger LOG = LoggerFactory.getLogger(MapBasedPropertyProvider.class);
    /**
     * The unit's entries.
     */
