...
public interface ManagedConfigMBean {
     ...
     */
    public Map<String, String> getConfiguration(String configName, String envContext)
     ...
     * @throws org.apache.tamaya.ConfigException If the configuration is not yet loaded.
     */
    public Map<String, String> getRecursiveConfigValues(String area, String configName, String envContext)
            throws ConfigException;
     ...
     * @throws org.apache.tamaya.ConfigException If the configuration is not yet loaded.
     */
    public Map<String, String> getConfigValues(String area, String configName, String envContext)
            throws ConfigException;
     ...
     *                                           mutable.
     */
    public Map<String, String> updateConfiguration(String configName, String envContext, Map<String, String> values, AggregationPolicy aggregationPolicy)
            throws ConfigException;
